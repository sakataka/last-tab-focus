...
The following ranks are the manual observations supplied at the start of this release. Chrome Web Store results can vary by locale, account, and time, so compare future checks under the same conditions.

| Query | Observed rank |
| --- | ---: |
| `previous tab focus` | 1 |
| `直前のタブ` | 2 |
| `タブを閉じたら前のタブ` | 3 |
| `close tab return previous` | about 6 |

## Public listing snapshot

- Published version: 1.1.8
- Updated: 2026-07-10
- Languages: en, ja, zh_CN, zh_TW
- Public user count observed during this work: 262–272 (the Web Store count changed while the page was being re-crawled)
